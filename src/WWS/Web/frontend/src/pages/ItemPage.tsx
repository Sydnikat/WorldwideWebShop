...
import {getCategory, getItem, getItemReviews, getItemsOfCategory, login, updateMyCart} from "../services/queries";
...
import {UpdateCartRequest} from "../types/Cart";
...
const ItemPage: React.FC<RouteComponentProps<ItemPageParams>> = (props: RouteComponentProps<ItemPageParams>) => {
  ...
  return(
    <AuthenticatedLayout>
      <Box m="3%" w="94%" borderWidth="1px" borderRadius="lg" overflow="hidden" bg="#fafafa" boxShadow="sm" pb="4" mb="1">
